...
NTS0409 
	- 25/1/24 modified to add a working age (16-64 y.o. inc) filter (for analysis of business trips)
...
_restrictToWorkingAge  constant smallint = 1; --restrict to 16-64 year old (inclusive) 
...
left join
tfwm_ntsdata.individual as I
on S.individualID = I.individualID
