...
_minUnweightedTripsPerWeek constant smallint = 1; --minimum number of unweighted trips per week (on a given mode) that person has to make to be counted in results.
...
_minNumVehicles constant smallint = 1; --minimum number of vehicles in either household or available to the individual (dependent on which bit of SQL enabled in query below)
/*
...
cteIndividualWithTrip(yearID, surveyYear, countryID, statsregID, laID, mmID, ageID, individualID, 
